...
permalink: /
subtitle: >
  <span data-lang-en>College of Geoscience and Surveying Engineering, China University of Mining and Technology - Beijing</span>
  <span data-lang-zh>中国矿业大学（北京）地球科学与测绘工程学院</span>
...
Current project work includes a scale-height research program connecting regional water-vapor climatology with the global ERA5-SH dataset, and GMR-Water, a MATLAB software package for multi-GNSS, multi-frequency, and multi-observation water-level retrieval.
...
目前重点项目包括贯通区域水汽气候特征与全球 ERA5-SH 数据集的对流层参量尺度高度研究，以及 GMR-Water 多 GNSS、多频点、多观测值水位反演 MATLAB 软件；相关代码、数据与文档均已通过 GitHub 或 Zenodo 开放。
