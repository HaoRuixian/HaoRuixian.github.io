---
layout: post
title: First Prize for Our Low-Cost GNSS-IR Tide Gauge
...
I recently participated in the Second Beijing University Science Association Alliance Innovation Scenario Challenge (2025) in the Future Information Track. My independently developed low-cost GNSS-IR tide-gauge project received First Prize and ranked first in the track. This achievement represents an important milestone in transforming several years of academic research into an innovation-oriented engineering project.

## From scientific research to an operational monitoring system

My recent research has focused on low-cost GNSS-IR sea-level and water-level monitoring. By integrating affordable GNSS hardware, edge-computing platforms, wireless communication, and real-time processing algorithms, I aim to build an intelligent monitoring system that can operate continuously and reliably over long periods.
...
近期，我参加了北京高校科协联盟第二届创新场景挑战赛（2025）未来信息赛道，并凭借自主研发的低成本 GNSS-IR 水位计项目获得赛道一等奖（第一名）。这是我将多年科研成果转化为创新创业和工程项目之后，取得的一项重要成绩。

## 从科研成果到实际监测系统

近年来，我一直围绕低成本 GNSS-IR 海（水）面高监测开展研究，希望通过低成本 GNSS 硬件、边缘计算平台、无线通信和实时数据处理技术，构建一套能够长期、连续、实时运行的智能水位监测系统。

除了完成科研论文和算法研究，我也在探索如何将这项技术进一步发展为可以实际使用的工程产品。本次参赛项目正是以这些研究成果为基础，重点突出低成本、高可靠性、易部署和长期运行等特点，希望为智慧水利、海洋监测以及防灾减灾等领域提供一种更加经济、高效的监测方案。
