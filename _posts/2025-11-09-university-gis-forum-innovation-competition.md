---
layout: post
title: Presenting Our Low-Cost GNSS-IR Tide Gauge at the University GIS Forum
...
I traveled to East China Normal University in Shanghai to participate in the 2025 13th University GIS Forum and entered its Innovation and Entrepreneurship Competition. This was my first experience presenting an academic research outcome as an innovation project and defending it from the perspectives of product design, practical application, and future development.

## Turning GNSS-IR research into an innovation project
...
前段时间，我前往上海华东师范大学参加了 2025 年第十三届高校 GIS 论坛，并报名参加了论坛同期举办的创新创业竞赛。这是我第一次将自己的科研成果以创新创业项目的形式进行展示和现场答辩，对我而言是一次十分宝贵的经历。

## 将 GNSS-IR 研究转化为创新项目

本次参赛项目围绕低成本 GNSS-IR 水位计展开。项目基于 GNSS 干涉反射技术，利用低成本 GNSS 接收机和自主设计的数据采集系统，实现连续、实时的水位监测，希望为传统潮位监测提供一种成本更低、部署更加灵活的补充方案，尤其适用于传统设备安装困难或建设成本较高的观测场景。
...
最终，项目获得了二等奖。虽然系统和项目展示仍有进一步提升的空间，但能够得到评委老师的认可，我依然感到十分欣慰。更重要的是，这次比赛锻炼了我的项目展示和现场答辩能力，也让我了解到创新创业项目在商业模式、用户需求、产品设计和成果转化方面需要重点考虑的问题。

除了参加比赛，这次上海之行还有一个令人开心的安排。我与高中同学王景阳再次见面交流。他目前正在复旦大学攻读计算机相关专业，我们围绕人工智能、计算机技术以及科研工作进行了深入交流，也分享了彼此近几年的学习和成长经历。跨学科的讨论为这次行程增加了另一层收获。

参加高校 GIS 论坛，不仅让我收获了一项竞赛奖项，也让我进一步体会到科研创新与成果转化之间的联系，并认识到跨学科交流对于推动技术发展的重要意义。未来，我希望继续完善低成本 GNSS-IR 水位计系统，让科研成果真正服务于水位和环境监测的实际应用。
