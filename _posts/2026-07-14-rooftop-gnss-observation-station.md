...
<figure class="blog-figure">
  <img src="/assets/img/blog/01-desk-debugging.jpeg" alt="The equipment being debugged at my workstation" loading="lazy">
  <figcaption><span data-lang-en>Debugging the equipment at my workstation.</span><span data-lang-zh>在工位调试设备。</span></figcaption>
</figure>

<figure class="blog-figure">
  <img src="/assets/img/blog/02-field-assembly.jpeg" alt="Fabricating the support bracket in the field" loading="lazy">
  <figcaption><span data-lang-en>Fabricating the support bracket in the field.</span><span data-lang-zh>外出进行支架的焊接制作。</span></figcaption>
</figure>
...
<figure class="blog-figure">
  <img src="/assets/img/blog/03-final-rooftop-station.png" alt="The completed rooftop observation station" loading="lazy">
  <figcaption><span data-lang-en>The completed rooftop observation station.</span><span data-lang-zh>最终安装完成的楼顶设备。</span></figcaption>
</figure>

<figure class="blog-figure">
  <img src="/assets/img/blog/04-building-view.png" alt="A view of the installed equipment from the ground" loading="lazy">
  <figcaption><span data-lang-en>The station viewed from the ground.</span><span data-lang-zh>从楼下看到的设备，非常骄傲！</span></figcaption>
</figure>
